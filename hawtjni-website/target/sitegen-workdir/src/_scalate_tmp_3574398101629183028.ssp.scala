...
object $_scalate_$_scalate_tmp_3574398101629183028_ssp {
...
class $_scalate_$_scalate_tmp_3574398101629183028_ssp extends _root_.org.fusesource.scalate.Template {
  def render(context: _root_.org.fusesource.scalate.RenderContext): Unit = $_scalate_$_scalate_tmp_3574398101629183028_ssp.$_scalate_$render(context)
}
