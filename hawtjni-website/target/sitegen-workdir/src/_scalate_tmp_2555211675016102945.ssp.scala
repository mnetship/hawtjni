...
object $_scalate_$_scalate_tmp_2555211675016102945_ssp {
...
class $_scalate_$_scalate_tmp_2555211675016102945_ssp extends _root_.org.fusesource.scalate.Template {
  def render(context: _root_.org.fusesource.scalate.RenderContext): Unit = $_scalate_$_scalate_tmp_2555211675016102945_ssp.$_scalate_$render(context)
}
