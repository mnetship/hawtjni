...
object $_scalate_$_scalate_tmp_6792989680581502770_ssp {
...
class $_scalate_$_scalate_tmp_6792989680581502770_ssp extends _root_.org.fusesource.scalate.Template {
  def render(context: _root_.org.fusesource.scalate.RenderContext): Unit = $_scalate_$_scalate_tmp_6792989680581502770_ssp.$_scalate_$render(context)
}
