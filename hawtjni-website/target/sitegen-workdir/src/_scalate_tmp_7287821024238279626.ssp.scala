...
object $_scalate_$_scalate_tmp_7287821024238279626_ssp {
  def $_scalate_$render($_scalate_$_context: _root_.org.fusesource.scalate.RenderContext): Unit = {
    ...
    import _root_.Website._;
        ...
        $_scalate_$_context << ( "<link rel=\"alternate\" title=\"" );
        $_scalate_$_context <<< (         project_name
 );
        $_scalate_$_context << ( " RSS\" href=\"index.rss\" type=\"application/rss+xml\">\n\n" );
      }
    }
  }
}
...
class $_scalate_$_scalate_tmp_7287821024238279626_ssp extends _root_.org.fusesource.scalate.Template {
  def render(context: _root_.org.fusesource.scalate.RenderContext): Unit = $_scalate_$_scalate_tmp_7287821024238279626_ssp.$_scalate_$render(context)
}
