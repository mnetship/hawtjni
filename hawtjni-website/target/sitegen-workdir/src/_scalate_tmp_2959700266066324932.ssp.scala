...
object $_scalate_$_scalate_tmp_2959700266066324932_ssp {
...
class $_scalate_$_scalate_tmp_2959700266066324932_ssp extends _root_.org.fusesource.scalate.Template {
  def render(context: _root_.org.fusesource.scalate.RenderContext): Unit = $_scalate_$_scalate_tmp_2959700266066324932_ssp.$_scalate_$render(context)
}
