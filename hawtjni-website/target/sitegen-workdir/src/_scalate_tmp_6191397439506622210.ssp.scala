...
object $_scalate_$_scalate_tmp_6191397439506622210_ssp {
  def $_scalate_$render($_scalate_$_context: _root_.org.fusesource.scalate.RenderContext): Unit = {
    ...
    import _root_.Website._;
        ...
        $_scalate_$_context << ( "\nThe latest and greatest news from the " );
...
class $_scalate_$_scalate_tmp_6191397439506622210_ssp extends _root_.org.fusesource.scalate.Template {
  def render(context: _root_.org.fusesource.scalate.RenderContext): Unit = $_scalate_$_scalate_tmp_6191397439506622210_ssp.$_scalate_$render(context)
}
