...
object $_scalate_$_scalate_tmp_7525779150286638169_ssp {
...
class $_scalate_$_scalate_tmp_7525779150286638169_ssp extends _root_.org.fusesource.scalate.Template {
  def render(context: _root_.org.fusesource.scalate.RenderContext): Unit = $_scalate_$_scalate_tmp_7525779150286638169_ssp.$_scalate_$render(context)
}
